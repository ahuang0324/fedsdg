...
python3 federated_main.py \
    ...
    --dirichlet_alpha 0.5 \
    --gpu 0 \
    --log_subdir fedsdg_cifar100_E80_alpha0.5
...
echo ""
echo "结果文件位置："
echo "  - TensorBoard 日志: logs/fedsdg_cifar100_E80_alpha0.5/"
echo "  - 实验总结: save/summaries/cifar100_vit_fedsdg_E80_summary.txt"
echo "  - 最终模型: save/models/cifar100_vit_final.pth"
echo ""
echo "查看 TensorBoard："
echo "  tensorboard --logdir=../logs/fedsdg_cifar100_E80_alpha0.5"
echo ""
